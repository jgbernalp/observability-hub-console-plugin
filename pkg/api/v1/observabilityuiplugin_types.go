...
type ObservabilityUIPluginSpec struct {
	...
	// +kubebuilder:validation:Required
	// +kubebuilder:validation:Enum=logs;distributed-tracing;perses-dashboards;korrel8r
...
func (in *ObservabilityUIPluginList) DeepCopyObject() runtime.Object {
	out := ObservabilityUIPluginList{}
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta

	if in.Items != nil {
		out.Items = make([]ObservabilityUIPlugin, len(in.Items))
